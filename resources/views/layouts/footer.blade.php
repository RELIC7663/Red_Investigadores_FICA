    ...
    <div class="container">
        ...
        <div class="row text-center text-md-start align-items-center">
            ...
            <div class="col-md-4 mb-4 mb-md-0">
                ...
                <p class="mb-1"><i class="bi bi-geo-alt"></i> Ciudadela Universitaria, Av. 17 de Julio 5-21 y General José María Córdova – Sector el Olivo. Ibarra, Ecuador</p>
                <p class="mb-1"><i class="bi bi-telephone"></i> +593 (6) 2 99 78 00 Ext. 7176</p>
