...
<head>
    ...
    <style>
        ...
        /* Agregado para los textos en la sección Miembros */
        .container h2 {
            color: white; /* Títulos de los miembros en blanco */
        }
        .container p {
...
<body>
    ...
    <div class="hero">
        ...
        <div class="hero-content">
            ...
            <p class="lead">Nuestra red está compuesta por diversos miembros comprometidos con la investigación sostenible.</p>
        </div>
    </div>
    ...
    <div class="container my-5">
        <div class="row">
            <div class="col-12">
                <h2 class="fw-bold">Miembro 1</h2>
                <p>xxxxxxx</p>
                <h2 class="fw-bold">Miembro 2</h2>
                <p>xxxxx</p>
                <h2 class="fw-bold">Miembro 3</h2>
                <p>xxxxxxxx</p>
                <h2 class="fw-bold">Miembro 4</h2>
                <p>xxxxxx</p>
            </div>
        </div>
    </div>
