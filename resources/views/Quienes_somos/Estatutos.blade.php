...
<div class="container my-5 bg-white p-4">
    ...
    <div class="bg-white p-4 rounded shadow-sm">
        ...
        <p class="mt-3 ms-4 ">El Comité Directivo o cualquiera de los miembros de la Red Internacional de
        ...
        <p class="mt-3 ms-4 ">La Asamblea General es la máxima autoridad de la RIPIS y está formada por todos los miembros. Se celebran dos tipos de asambleas:</p>
